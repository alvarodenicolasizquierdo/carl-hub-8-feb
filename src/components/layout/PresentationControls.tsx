      ...
      {isPresenting && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1 rounded-full bg-card/90 backdrop-blur-xl border border-border/40 shadow-2xl px-2 py-1.5 transition-opacity duration-300 ${
